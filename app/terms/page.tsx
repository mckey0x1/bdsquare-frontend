      ...
      <div className="space-y-8">
        <section>
          ...
          <div className="space-y-4 text-gray-700">
            <p>
              By accessing and using ClothesStore's website and services, you accept and agree to 
        ...
        <section>
          ...
          <div className="space-y-4 text-gray-700">
            <p>
              Permission is granted to temporarily download one copy of the materials on ClothesStore's 
        ...
        <section>
          ...
          <div className="space-y-4 text-gray-700">
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              ...
              <li>Understand that order confirmation does not guarantee acceptance</li>
            </ul>
            <p>
        ...
        <section>
          ...
          <div className="space-y-4 text-gray-700">
            <p>
              ...
              However, delivery dates are estimates and not guaranteed.
            </p>
            <ul className="list-disc list-inside space-y-2 ml-4">
        ...
        <section>
          ...
          <div className="space-y-4 text-gray-700">
            <p>
              ...
              for returns within 30 days of delivery.
            </p>
            <ul className="list-disc list-inside space-y-2 ml-4">
        ...
        <section>
          ...
          <div className="space-y-4 text-gray-700">
            <p>
              ...
              the exclusive property of ClothesStore and its licensors. The service is protected by 
        ...
        <section>
          ...
          <div className="space-y-4 text-gray-700">
            <p>
              In no event shall ClothesStore, nor its directors, employees, partners, agents, suppliers, 
        ...
        <section>
          ...
          <div className="space-y-4 text-gray-700">
            <p>
              ...
              of the State and you irrevocably submit to the exclusive jurisdiction of the courts 
        ...
        <section>
          ...
          <div className="space-y-4 text-gray-700">
            ...
            <ul className="list-none space-y-2 ml-4">
              <li><strong>Email:</strong> legal@clothestore.com</li>
